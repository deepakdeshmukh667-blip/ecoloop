    ...
    <aside className="fixed left-0 top-16 bottom-0 w-64 bg-white dark:bg-[#131d31] border-r border-[#e2e8f0] dark:border-[#1e293b] hidden md:flex flex-col justify-between py-6 px-4 z-40 shadow-[0_1px_8px_rgba(0,0,0,0.02)]">
      <nav className="flex flex-col gap-1.5">
        ...
        <button
          ...
          className="flex items-center gap-3 px-3.5 py-2.5 rounded-xl text-sm font-medium text-[#64748b] hover:bg-[#fee2e2] dark:hover:bg-[#991b1b]/20 hover:text-[#ba1a1a] dark:text-[#94a3b8] dark:hover:text-[#ff8585] transition-all mt-2 cursor-pointer text-left"
        >
      ...
      {!isAdmin ? (
        ...
        <div className="flex flex-col gap-2 bg-[#006c49]/5 dark:bg-[#006c49]/15 p-4 rounded-xl border border-[#006c49]/20">
          <div className="flex items-center justify-between">
            <span className="text-[11px] text-[#006c49] dark:text-[#34d399] uppercase tracking-wider font-bold">
              MCGM Compliance
            </span>
            <span className="text-xs font-bold text-[#006c49] dark:text-[#34d399]">Grade AA</span>
          </div>
          <p className="text-[11px] text-[#64748b] dark:text-[#94a3b8] leading-tight">
            Ward 88B • Society Municipal Verification Portal active.
          </p>
        </div>
      )}
    </aside>
